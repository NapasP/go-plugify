...
## [1.11.0](https://github.com/NapasP/go-plugify/compare/v1.10.4...v1.11.0) (2026-08-24)


### Features

* add better custom path splitting ([04c7297](https://github.com/NapasP/go-plugify/commit/04c729787f638a5ce305fd2c1095e87de0d636ac))
* add error handling, add plugin interface ([91bc0b0](https://github.com/NapasP/go-plugify/commit/91bc0b096d492596f7885bc515fbd9b7486447fb))
* add logger ([a8d97e3](https://github.com/NapasP/go-plugify/commit/a8d97e300d0ce0cfcedb78b6c83dd3d5c38926bb))
* add new generator parser tool ([bc018e8](https://github.com/NapasP/go-plugify/commit/bc018e8b626e3a56395bf7eaff264b540163219b))
* add path getters ([c2a36ad](https://github.com/NapasP/go-plugify/commit/c2a36ad23768a6b14c2d7e865a1155c4c40af2e0))
* breaking changes ([b11d453](https://github.com/NapasP/go-plugify/commit/b11d453870a1e9151592cdd32011c96777d46430))
* change api for string getters ([069f89e](https://github.com/NapasP/go-plugify/commit/069f89e3815f4d970441e4d0bee3de7e403624e5))
* changed ToString method to String for Vector2/3/4/Matrix4x4 to honor fmt.Stinger interface. ([05b8696](https://github.com/NapasP/go-plugify/commit/05b869646cddc45c7c83a80060586dd64c98c1d6))
* implemented type system & reworked generator ([a0d056c](https://github.com/NapasP/go-plugify/commit/a0d056cb4c353321e2e6a03af9fee8fcd4657b30))
* rework for  plugin mode builds ([e8bb384](https://github.com/NapasP/go-plugify/commit/e8bb384627b1dac17cd21747eb32bdc72d00442a))


### Bug Fixes

* add casts for 32bit mode ([9d08351](https://github.com/NapasP/go-plugify/commit/9d0835103446d2ac5d22aca1d14c91c8dbb1099f))
* add combability with 32 bit ([3ae92b0](https://github.com/NapasP/go-plugify/commit/3ae92b0ecd2170e892e9a1d6a0378bc3fd72954b))
* add dependencies and conflicts to manifest generator ([09511bb](https://github.com/NapasP/go-plugify/commit/09511bbf71cd58db4b81dc9427f40100fb0f6bfe))
* add error signalling for invalid parameter types ([7dcd59d](https://github.com/NapasP/go-plugify/commit/7dcd59db93883c2d790582fb93e7452e3241a7e3))
* add loaded flag and force gb on unload ([685247f](https://github.com/NapasP/go-plugify/commit/685247f9c4c562c2ed98e56aafcbe012f9ebe5d3))
* add location getter ([1d1ce7f](https://github.com/NapasP/go-plugify/commit/1d1ce7f0305e4154afab92b94b4da6ebce988394))
* add missing callback ([e603e61](https://github.com/NapasP/go-plugify/commit/e603e6121957e223086937b5555b7a27362d6bc7))
* add missing includes to Linux ([caca727](https://github.com/NapasP/go-plugify/commit/caca7278f5a7e84554c75382c660af01a41c89ca))
* add mutexes to function marshalling ([e6474d1](https://github.com/NapasP/go-plugify/commit/e6474d160be90bd3f6b54de7a7f4e05aa803780f))
* add parser and move generators to separate folders ([84b1255](https://github.com/NapasP/go-plugify/commit/84b1255462499cb21863f189449734a59f270d90))
* add plugin context ([21d8963](https://github.com/NapasP/go-plugify/commit/21d8963ae1b1382d42c1185ad1ee838269475924))
* add profiler ([1607c76](https://github.com/NapasP/go-plugify/commit/1607c7628217b8ca959e35a4ae3c2228a190dc17))
* add sem versioning ([dafce37](https://github.com/NapasP/go-plugify/commit/dafce37c4800140d082011beb027cb1799391f43))
* add stacktrace to internal calls and make some methods private ([78daaed](https://github.com/NapasP/go-plugify/commit/78daaed4f76cb99bc111e6f1f66cd3675e03c3a2))
* add support of uintptr ([a655b3e](https://github.com/NapasP/go-plugify/commit/a655b3e410290625b540b5cbe47c034f029295b4))
* add x86 support ([fdcf54d](https://github.com/NapasP/go-plugify/commit/fdcf54d7f3af5dc51e29ec688b485dfbeaa0c6ee))
* Any type unaddressable reflect panic ([84c59c9](https://github.com/NapasP/go-plugify/commit/84c59c9f2e48be4556bbcbf1caef2fafe97af0f3))
* apple clang missed uchar.h ([e0552e2](https://github.com/NapasP/go-plugify/commit/e0552e2e6da440c700d38b82329d9bc40419f482))
* bump golang version ([3f5b32b](https://github.com/NapasP/go-plugify/commit/3f5b32b0fe22f68f5ffe2312218a7a779e6a2586))
* call start and update every time ([e1f0897](https://github.com/NapasP/go-plugify/commit/e1f08972d688b267f10146cf44327e63e7827ea5))
* callback param name and description not generated & plugify not exported at autoexports.go ([121b3a8](https://github.com/NapasP/go-plugify/commit/121b3a866aed636098ca2b8067d060388ffb5bc2))
* callback param name and description not generated & plugify not exported at autoexports.go (2) ([645eddd](https://github.com/NapasP/go-plugify/commit/645eddd7dbffa32226bcbecfc8da62a2298e1ca1))
* **cgo:** type String/Vector pointer fields as uintptr_t to stop GC false-positive "pointer to free object" ([7a40c95](https://github.com/NapasP/go-plugify/commit/7a40c95c020fa5a1d1bfc3bd030a0459abcfa70d))
* change release type to go ([7685b82](https://github.com/NapasP/go-plugify/commit/7685b829f74f29a7f76772930bb197412f914619))
* changes in api ([ba850eb](https://github.com/NapasP/go-plugify/commit/ba850eb834d6f0dda26a4d62d291705ceaaa7b2e))
* **claude:** add [@brief](https://github.com/brief) for main doc ([73f6d4c](https://github.com/NapasP/go-plugify/commit/73f6d4c0a5db3bcfee658ab46f0968bba4db2d70))
* **claude:** add doxygen parser ([6a5d9db](https://github.com/NapasP/go-plugify/commit/6a5d9db22fa8ea956fec7b72472e66bc62c654fe))
* **claude:** add extraction of documentation for enums and generate ([85ce6cd](https://github.com/NapasP/go-plugify/commit/85ce6cdbd6eef7e0da632c594cce11c7ab45edfc))
* **claude:** delegate documentation parsing ([eeefb7f](https://github.com/NapasP/go-plugify/commit/eeefb7fabda8033937e0a773c9bc794a399cb1d7))
* **claude:** enum description generation ([43a2633](https://github.com/NapasP/go-plugify/commit/43a2633d87888447cce38db73c8a4dfde91a8591))
* **claude:** enum description generation (2) ([7357b87](https://github.com/NapasP/go-plugify/commit/7357b873e8b051eb2030c205c0bb9efe798053f7))
* **claude:** fix issues with generator.go ([387517c](https://github.com/NapasP/go-plugify/commit/387517cb5ac615838d6690d67584a5d947fce738))
* **claude:** warnings on unused ([8428136](https://github.com/NapasP/go-plugify/commit/8428136eed6faa0a849908375e58e752a6a592b2))
* export names ([4fd5b9c](https://github.com/NapasP/go-plugify/commit/4fd5b9c024c0ed43258fb7d08e93d921e0f4ba19))
* export typo ([70b5927](https://github.com/NapasP/go-plugify/commit/70b5927476596d9a6447b0eef2d7f80aed627e99))
* expose PrintException ([35b5724](https://github.com/NapasP/go-plugify/commit/35b57240243d5590242889e55fdb54f49c597354))
* fixed invalid function type ([02aea01](https://github.com/NapasP/go-plugify/commit/02aea01e58b66be897e7fe8acb05b6b39fddba69))
* fixed slice's element types import paths ([68ef2ed](https://github.com/NapasP/go-plugify/commit/68ef2edaf6391e207b85e30fb88b66a930655b02))
* function comparison ([413d668](https://github.com/NapasP/go-plugify/commit/413d668bab8cc76a7e6f7d6daeb0f44c503b874e))
* hidden return on win arm and x86 ([08cd10d](https://github.com/NapasP/go-plugify/commit/08cd10df93c2cb1f4182c64834f4384195dccead))
* improve duplicate validation ([3a51dd3](https://github.com/NapasP/go-plugify/commit/3a51dd36c5adc95f8e9e62486200219b422f08ec))
* improve string handling ([f1aa056](https://github.com/NapasP/go-plugify/commit/f1aa05625957b54bd3e121355c003e1132f7b6d9))
* improve string/variant pulling ([f47cf5f](https://github.com/NapasP/go-plugify/commit/f47cf5f0760bd61eb745634f9907b92daa69078e))
* improvements for marshalling ([a0a6da4](https://github.com/NapasP/go-plugify/commit/a0a6da44b692f214ddf099b01993d11522d6086d))
* int/uint on 32bit ([a25d642](https://github.com/NapasP/go-plugify/commit/a25d642847f194414c10d57ddbdb382e2a78db12))
* leaking memory on reassigning existing variant ([7e31f2e](https://github.com/NapasP/go-plugify/commit/7e31f2e282d57922b31d3b9307bf1059915080a1))
* make param array 64 bit for JitCall ([13b5df2](https://github.com/NapasP/go-plugify/commit/13b5df221a490343a66b2a7a3e000aa95fd7eaf5))
* make plugin public ([def1a02](https://github.com/NapasP/go-plugify/commit/def1a0280b5d1db9e07d756f6c8b03c76b4bd335))
* make plugin public ([bd0cb50](https://github.com/NapasP/go-plugify/commit/bd0cb503fbe86118c5986008a9295d5d116fd54d))
* matrix4x4 formatting ([f8decc2](https://github.com/NapasP/go-plugify/commit/f8decc21953038a26bd3b3dbc05356fd43a6c245))
* missing name and description in enums/aliases ([c48281a](https://github.com/NapasP/go-plugify/commit/c48281abdefd570887cc0f30597a4554c8be5c7b))
* more rework for plugin system ([1d12060](https://github.com/NapasP/go-plugify/commit/1d1206064b04cdc0cf3c195b8d442024fe1839e9))
* more rework for plugin system (2) ([087246a](https://github.com/NapasP/go-plugify/commit/087246a523cda00906dc6c02228aa49a3965fafd))
* more rework for plugin system (3) ([73868ec](https://github.com/NapasP/go-plugify/commit/73868ec8fc522dbda0a5b156b9cc8e0395d2536b))
* no return function ([55d14a3](https://github.com/NapasP/go-plugify/commit/55d14a373531c3840a35c4a6f159e728cc192d7d))
* pplugin callback name and description missing ([9b8b91f](https://github.com/NapasP/go-plugify/commit/9b8b91f7a42c9c1332c6753dc6586c271a3e86b7))
* prevent adding two same imports ([58e4716](https://github.com/NapasP/go-plugify/commit/58e47167d51d5a348d44fbb0da8f46e19858e20a))
* prevent calling log if severity is low ([b53c163](https://github.com/NapasP/go-plugify/commit/b53c163c74e38aa08c9c6848465fad6c6ff1dd5b))
* refactor of marshal class ([dd2d660](https://github.com/NapasP/go-plugify/commit/dd2d660e63352e9c31340dc90698ffb473eda29c))
* remove cgo nocallback ([e7100d8](https://github.com/NapasP/go-plugify/commit/e7100d83fa713a6099ac9760850e2e1c1b95d097))
* remove char16 macro ([539173b](https://github.com/NapasP/go-plugify/commit/539173b086d86aa6d3b1db2b9e1bed4a8ffccb6f))
* remove get method ptr ([b8d60c8](https://github.com/NapasP/go-plugify/commit/b8d60c8da63a955262ae3f8061c8b18df5a8488e))
* remove GetBaseDir setter ([45c925f](https://github.com/NapasP/go-plugify/commit/45c925f36fad17505de7239fe074be4ac42afaab))
* remove matrix4x4 from any as it not initially was supported ([7d8d362](https://github.com/NapasP/go-plugify/commit/7d8d362e397381b1469cfaba6de81d440fc21545))
* remove missing methods ([76af23d](https://github.com/NapasP/go-plugify/commit/76af23dc044f8a0fef8e53bc649ed08bb3f0c5c6))
* remove panic ([ad7cc88](https://github.com/NapasP/go-plugify/commit/ad7cc8884908195a1446c6810e5f1c530bc0010a))
* remove panic from context ([d4a0214](https://github.com/NapasP/go-plugify/commit/d4a0214185ff6bf33edb23f187ee5066ae5c185c))
* remove println typo ([bea9eb3](https://github.com/NapasP/go-plugify/commit/bea9eb376e95bef9f644ed1bfb65d2a6b9bc58cb))
* remove unused functions ([f142917](https://github.com/NapasP/go-plugify/commit/f142917e65d54fcbc629ac6abcc5ed0aaf8ebb79))
* remove unused param ([a6092cd](https://github.com/NapasP/go-plugify/commit/a6092cda1fd9c68d0f1f15e86bde105bfe5ae517))
* removed redundant alias import ([914d906](https://github.com/NapasP/go-plugify/commit/914d9064dfe556fa05d17eebe9e19bcdd14e695b))
* removed unnecessary functions ([7f17d9c](https://github.com/NapasP/go-plugify/commit/7f17d9c056b9550647ce4be485a17204cf83d86d))
* removed unused code & made some methods private ([9c7a59a](https://github.com/NapasP/go-plugify/commit/9c7a59a5bb26cde68ca438db288ac786190f0fc5))
* rename verbose to trace ([0243ab1](https://github.com/NapasP/go-plugify/commit/0243ab1a04f53843432ae8566354df82376bccbe))
* renamed some functions ([c0bd8c5](https://github.com/NapasP/go-plugify/commit/c0bd8c57372923d29bb947257f8462033db348e4))
* rework logger ([1de3940](https://github.com/NapasP/go-plugify/commit/1de394099f99b603d8b2eb1776f2b3d1e0800096))
* rework manifest generation ([8b7deaf](https://github.com/NapasP/go-plugify/commit/8b7deaf52345afc043cd76ed076299a95ad40152))
* rework pool allocation to stack memory ([0e5a0bd](https://github.com/NapasP/go-plugify/commit/0e5a0bd7331e5d3a4632efef78f06bcc3795ba2e))
* size for char16 memcpy ([40cdf41](https://github.com/NapasP/go-plugify/commit/40cdf417508e599f3349c96144b4460d84ad179f))
* small refactor ([e2826c4](https://github.com/NapasP/go-plugify/commit/e2826c4e9734ac7e0b280d656c1ff7a8aa0f8dcc))
* some code cleanup ([299ca90](https://github.com/NapasP/go-plugify/commit/299ca907aa3c253468690358d50356c6752afb7e))
* some gen improvements ([f5b0a2c](https://github.com/NapasP/go-plugify/commit/f5b0a2c7c27f4af20caf13d502c28624dd565651))
* trigger release pipeline ([d7c3592](https://github.com/NapasP/go-plugify/commit/d7c3592cba3b4d218e2cafbf1211c88dd54ac8b4))
* update for a new plugify ([14b4221](https://github.com/NapasP/go-plugify/commit/14b42212c218629e787e89575fef829be9173240))
* update for new plugify ([36caee2](https://github.com/NapasP/go-plugify/commit/36caee2008929141370e049ef557a5e6e9dff9fd))
* update generaotr ([dbcdef8](https://github.com/NapasP/go-plugify/commit/dbcdef88cb33738c71e6d7041d34922dfef61da0))
* update go ([40c704e](https://github.com/NapasP/go-plugify/commit/40c704e295733f1b94ffd324e52890f4a88a0ec7))
* update IsPluginLoaded and IsModuleLoaded ([86bba60](https://github.com/NapasP/go-plugify/commit/86bba60d25adcd7d6422feb3eb192f1c5266a72f))
* update native flags for new funcs ([5854d61](https://github.com/NapasP/go-plugify/commit/5854d6141a64628c0a8a11d1e19f083d73e57f10))
* update profiler ([31c7764](https://github.com/NapasP/go-plugify/commit/31c776424bad7bf22a853a1d10d053a671ca0a91))
* update readme and add missing permission ([1f544e9](https://github.com/NapasP/go-plugify/commit/1f544e93ce0fdeffc5b06332c7072b216fef1c46))
* use cap for slice size ([3348cca](https://github.com/NapasP/go-plugify/commit/3348cca709aaae2b1802e09d5f642f5f02b50056))
